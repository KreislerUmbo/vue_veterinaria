...
const store = async () => {
    ...
    try {
        ...
        if (resp.message == 403) {
            ...
            success.value = "EL VETERINARIOS SE HA EDITADO CON EXITO";
        }
        setTimeout(() => {
            success.value = null;
            warning.value = null;
...
const show = async () => {
      try {
       ...
       schedule_hours_veterinrie.value=veterinarie_selected.value.schedule_hours_veterinrie;
        ...
        <VCard class="refer-and-earn-dialog pa-3 pa-sm-11">
            ...
            <VCardText class="pa-5 py-0">
                <VBtn color="primary" class="mb-4" @click="store()">
                 ...
                 <VBtn color="danger" class="mb-4 px-5" @click="route.back()">
                    Regresar
                </VBtn>
            </VCardText>
